                ...
                <div class="list-group-item d-flex flex-column gap-2">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <a href="<?php echo e(route('conta.desfazer', ['conta_id' => $conta->conta_id])); ?>" class="btn btn-warning btn-sm">Desfazer operação</a>
                        </div>
                    </div>

                    <!-- Formulário de depósito -->
                    <form action="<?php echo e(route('conta.depositar')); ?>" method="POST" class="deposito-form" style="display: none;">
                        <?php echo csrf_field(); ?>
                    ...
                    <form action="<?php echo e(route('conta.transferir')); ?>" method="POST" class="transferir-form" style="display: none;">
                        <?php echo csrf_field(); ?>
